...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item"><a href="<?php echo U('login/index');?>">退了</a></li>
        </ul>
    </div>
    ...
    <div class="layui-body emp-content">
        ...
        <form class="layui-form" method="post" action="doadd">
            <div class="layui-form-item">
                ...
                <input class="layui-input layui-input-inline" type="text" name="Ename">
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">年龄</label>
                <input class="layui-input layui-input-inline" type="text" name="Eage">
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">部门</label>
                <div class="layui-input-inline">
                    <select name="Edeptno">
                        <?php if(is_array($depts)): $i = 0; $__LIST__ = $depts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dept): $mod = ($i % 2 );++$i;?><option value="<?php echo ($dept["dno"]); ?>"><?php echo ($dept["dname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
