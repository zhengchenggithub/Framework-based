...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="index.php?controller=emplist&method=add">员工添加</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body emp-content">
        ...
        <form class="layui-form" method="post" action="doeditor">
            <input type="hidden" name="Eno" value="<?php echo ($emp[0]['eno']); ?>">
            <div class="layui-form-item">
                <label class="layui-form-label">员工姓名</label>
                <input class="layui-input layui-input-inline" type="text" name="Ename" value="<?php echo ($emp[0]['ename']); ?>">
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">年龄</label>
                <input class="layui-input layui-input-inline" type="text" name="Eage" value="<?php echo ($emp[0]['eage']); ?>">
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">部门</label>
                <div class="layui-input-inline">
                    <select name="Edeptno">
                        <?php if(is_array($depts)): $i = 0; $__LIST__ = $depts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dept): $mod = ($i % 2 );++$i; if($emp[0][edeptno] == $dept[dno]): ?><option selected value="<?php echo ($dept["dno"]); ?>"><?php echo ($dept["dname"]); ?></option>
                        <?php else: ?>
