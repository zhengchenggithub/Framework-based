...
<div class="tpt-wp tpt-pat-75 cl">
	<div class="tpt-ml-7">
		<div class="tpt-banner cl">
			<div class="tpt-ml-6">
				<div class="tpt-a">
					<a href="<?php echo ($tptf["alink"]); ?>" title="<?php echo ($tptf["atitle"]); ?>"><img src="/phpText/Tpt-Blog1.1/Uploads<?php echo ($tptf["apic"]); ?>" alt="<?php echo ($tptf["atitle"]); ?>"></a>
					<h2><a href="<?php echo ($tptf["alink"]); ?>" title="<?php echo ($tptf["atitle"]); ?>"><?php echo ($tptf["atitle"]); ?></a></h2>
				</div>
			</div>
			<div class="tpt-mr-4">
				<ul class="tpt-b">
					<li><a href="<?php echo ($tptf["blink"]); ?>" title="<?php echo ($tptf["btitle"]); ?>"><img src="/phpText/Tpt-Blog1.1/Uploads<?php echo ($tptf["bpic"]); ?>" alt="<?php echo ($tptf["btitle"]); ?>"></a>
					<h2><a href="<?php echo ($tptf["blink"]); ?>" title="<?php echo ($tptf["btitle"]); ?>"><?php echo ($tptf["btitle"]); ?></a></h2>
					</li>
					<li><a href="<?php echo ($tptf["clink"]); ?>" title="<?php echo ($tptf["ctitle"]); ?>"><img src="/phpText/Tpt-Blog1.1/Uploads<?php echo ($tptf["cpic"]); ?>" alt="<?php echo ($tptf["ctitle"]); ?>"></a>
