...
<div class="inside">
      <div class="inwp cl">  
        ...
        <ul>
            <li class="innumber innumber1">4</li>
...
<div class="inside2">
	<div class="inwp cl">
		<h2>恭喜您安装成功</h2>
		<h3>后台默认账号：admin，密码：admin，口令：123456</h3>
		<div class="inout1">
			<a href="/phpText/Tpt-Blog1.1/index.php" target="_blank">去前台首页</a>
		</div>
		<div class="inout2">
			<a href="/phpText/Tpt-Blog1.1/admin.php?m=Admin&c=login&a=index" target="_blank">去后台首页</a>
		</div>
	</div>
</div>
</body>
